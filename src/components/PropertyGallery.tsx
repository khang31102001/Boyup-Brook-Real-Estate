...
const PropertyGallery = () => {
  ...
  const [_fullscreenImageIndex, setFullscreenImageIndex] = useState(0);
  ...
  return (
    <motion.section id="bridgetown" className="py-20 flex flex-col justify-center items-center bg-gray-50">
      <div className="container px-4">
        <div className="text-center mb-14">
          ...
          <motion.p
           ...
           className="text-normal text-gray-700 max-w-3xl mx-auto text-center px-0 md:px-4 mt-4"
          >
        ...
        >
          {images.map((image, index) => (
           ...
           <motion.button
               ref={prevRef}
                className=" custom-button-next absolute top-[31%] left-2 p-1.5 sm:p-2 rounded-full bg-emerald-600 hover:bg-emerald-700 shadow-lg transition-colors"
              ...
              <motion.button
                ref={nextRef}
                className="custom-button-prev absolute top-[31%] right-2 p-1.5 sm:p-2 rounded-full bg-emerald-600 hover:bg-emerald-700 shadow-lg transition-colors"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
