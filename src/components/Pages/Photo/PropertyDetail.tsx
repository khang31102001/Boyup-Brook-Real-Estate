  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className='flex flex-row lg:grid lg:grid-cols-4 gap-4'>
        ...
        <div className="bg-white h-fit col-span-1 rounded-lg shadow-md p-6 mb-8 w-full">
          <div className="flex flex-col items-center w-full">
            ...
            <div className="flex flex-col gap-2 w-full">
              <Link to={'/contact'} className="bg-red-600 text-white px-6 py-2 rounded-md hover:bg-red-700 w-full" onClick={() => window.scrollTo(0, 0)}>
                Get in touch
              </Link>
              ...
              <a href="tel:+0457230191" className="text-emerald-900 w-full flex items-center border border-gray-300 px-4 py-2 rounded-md hover:bg-gray-50">
                Phone: 0457230191
              </a>
            </div>
          </div>
